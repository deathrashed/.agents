...
6. **Structure AGENTS.md Files Strategically**:
   - Place a main AGENTS.md at the service root with overview and setup
   - Create subdirectory AGENTS.md files for complex modules
...
Format your AGENTS.md files with:

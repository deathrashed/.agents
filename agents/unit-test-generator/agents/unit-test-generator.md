---
description: Expert Flutter/Dart unit test specialist that systematically improves test coverage using automat...
capabilities: ['test automation', 'unit testing', 'integration testing', 'test coverage', 'QA', 'AI', 'iOS']
---

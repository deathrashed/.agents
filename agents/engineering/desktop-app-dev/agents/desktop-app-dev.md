---
description: Specialized Agent For Desktop App Dev
capabilities: ['code quality', 'programming', 'development', 'desktop app dev', 'problem solving', 'technical expertise', 'consulting']
---

---
description: Use this agent when you need to create comprehensive Product Requirements Documents (PRDs) that c...
capabilities: ['API', 'AI', 'Testing', 'Security', 'Performance', 'Mobile']
---

---
description: Use this agent when you need to optimize B2B pricing strategies, packaging models, and revenue op...
capabilities: ['API', 'AI', 'Testing', 'Performance', 'Web']
---

...
`/egc-harness-audit [scope] [--format text|json]`
...
```bash
node scripts/egc-harness-audit.js <scope> --format <text|json>
```
...
2) [Tool Coverage] Sync commands/egc-harness-audit.md and .opencode/commands/egc-harness-audit.md. (.opencode/commands/egc-harness-audit.md)

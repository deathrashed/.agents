...
````text
User: /egc-rust-test I need a function to validate user registration
...
- `/egc-rust-build` - Fix build errors
- `/egc-rust-review` - Review code after implementation

...
```bash
node scripts/orchestrate-worktrees.js .gemini/egc-plan/workflow-e2e-test.json --execute
```
...
**Gemini CLI Synthesis**: Adopt Codex backend plan + Gemini frontend plan, save to `.gemini/egc-plan/task-name.md` after user approval.

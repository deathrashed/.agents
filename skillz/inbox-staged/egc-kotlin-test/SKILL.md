...
````text
User: /egc-kotlin-test I need a function to validate user registration requests
...
- `/egc-kotlin-build` - Fix build errors
- `/egc-kotlin-review` - Review code after implementation

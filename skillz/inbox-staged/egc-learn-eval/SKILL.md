---
name: egc-learn-eval
description: /egc-learn-eval - Extract, Evaluate, then Save
---
---
description: "Extract reusable patterns from the session, self-evaluate quality before saving, and determine the right save location (Global vs Project)."
---

# /egc-learn-eval - Extract, Evaluate, then Save

Extends `/egc-learn` with a quality gate, save-location decision, and knowledge-placement awareness before writing any skill file.

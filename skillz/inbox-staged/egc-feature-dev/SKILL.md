...
```
/egc-feature-dev Add user profile page with avatar upload
```

## Related Commands

- `/egc-plan` — Create implementation plan first
- `/egc-tdd` — Test-driven development workflow
- `/egc-code-review` — Standalone code review

...
````
User: /egc-cpp-test I need a function to validate email addresses
...
- `/egc-cpp-build` - Fix build errors
- `/egc-cpp-review` - Review code after implementation

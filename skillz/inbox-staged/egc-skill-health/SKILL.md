---
name: egc-skill-health
description: Skill Health
---
---
name: skill-health
...
```
/egc-skill-health                    # Full dashboard view
/egc-skill-health --panel failures   # Only failure clustering panel
/egc-skill-health --json             # Machine-readable JSON output
```
...
3. If any skills are declining, highlight them and suggest running /egc-evolve

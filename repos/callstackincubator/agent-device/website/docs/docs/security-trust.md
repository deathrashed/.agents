...
description: Security and trust guidance for agent-device local app automation, MCP discovery, device permissions, screenshots, recordings, logs, network dumps, traces, and reports.
---

...
gh api repos/borghei/claude-code-skills/milestones \
...
gh api repos/borghei/claude-code-skills/milestones | jq '.[] | select(.title=="CS- Orchestrator Framework v1.0") | .number'
...
MILESTONE_NUM=$(gh api repos/borghei/claude-code-skills/milestones | jq '.[] | select(.title=="CS- Orchestrator Framework v1.0") | .number')

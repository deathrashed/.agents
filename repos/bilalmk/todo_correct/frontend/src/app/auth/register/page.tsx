/**
 * Register Page - Updated with Orange/Coral Theme
 *
 * Features (per tasks.md T029):
...
export const metadata: Metadata = {
  title: "Create Account - Todo Evolution",
  description: "Create your free Todo Evolution account and start managing your tasks today.",
};
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-6">
            By signing up, you'll get access to all features for free
          </p>
        </div>
      </main>
    </div>

...
3. Delegate decomposition to `omg-planner`.
4. Delegate architecture-sensitive risks to `omg-architect`.
...
10. When the runtime exposes `GEMINI_PLANS_DIR`, prefer it for native plan-session references and keep OmG taskboard/checkpoint links explicit.

...
4. Map global effort to OmA posture:
   - planning depth
...
8. Clarify boundary: this profile controls OmA orchestration behavior and recommendations, not Gemini runtime flags directly.

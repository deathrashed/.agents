---
name: notify
description: Inspect or configure OmA notification routing for approval gates, verification outcomes, blockers, and long-running sessions.
---
Run OmA notification manager.
...
3. Supported channels:
   ...
   - `webhook` (external bridge managed outside OmA)
...
5. Enforce extension boundary:
   - OmA manages trigger policy, templates, and state artifacts.

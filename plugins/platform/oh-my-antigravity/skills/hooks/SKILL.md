---
name: hooks
description: Inspect or configure OmA hook pipeline profiles, triggers, and safety policy.
---
Run OmA hook pipeline manager.
...
7. Detect duplicate delivery risk:
   - if the same OmA hook appears to be registered through both extension-managed hooks and a manual/user-maintained hook file, call out the coexistence risk explicitly

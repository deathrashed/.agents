---
name: hud
description: Inspect or switch OmA HUD visibility profile (normal, compact, hidden) for visual status rendering.
---
Run OmA HUD profile manager.
...
6. Clarify capability boundary: Gemini Extensions cannot patch terminal statusline hooks directly, so this profile controls how `/oma:status` renders visual summaries.

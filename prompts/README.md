...
**Quick Start**:
1. Choose a category folder under `prompts/` (`auth/`, `db-orm/`, `frameworks/`, `meta/`, `ui-styling/`)
2. Create a folder for your prompt pack (`prompts/<category>/<your-prompt-name>`)
3. Include prompt `.md` or `.mdc` files with YAML frontmatter for rules

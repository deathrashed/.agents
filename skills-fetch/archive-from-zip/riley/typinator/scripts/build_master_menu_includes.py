#!/usr/bin/env python3
"""Build master menu targeting Includes-hosted CSV sets by default.

Default base:
  /Users/rd/.config/typinator/Sets/Includes/Exported/Cleaned
...
DEFAULT_BASE = Path("/Users/rd/.config/typinator/Sets/Includes/Exported/Cleaned")
